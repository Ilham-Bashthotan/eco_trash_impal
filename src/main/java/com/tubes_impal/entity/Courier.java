...
public class Courier {
    ...
    public Courier(Integer id, User user, Admin hiredBy, Integer maxVisitsADay, Integer age, String drivingLicence, String idCard, StatusCourier status, Integer successfulDeliveries, Integer failedDeliveries, List<TrashOrder> trashOrders, List<CourierDailyStats> dailyStats) {
        this.id = id;
        this.user = user;
